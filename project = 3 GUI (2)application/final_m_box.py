...
# labels
name_label = ttk.Label(label_frame, text = 'Enter your Name please : ',font=('Helvetic', 14, 'bold'))
age_label = ttk.Label(label_frame, text='Enter your age please : ',font=('Helvetic', 14, 'bold'))
